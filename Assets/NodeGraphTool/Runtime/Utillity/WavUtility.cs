...
public class WavUtility
{
    ...
    public static byte[] FromAudioClip(AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirname = "recordings",string fileName="tts")
    {
        ...
        if (saveAsFile)
        {
            filepath = string.Format("{0}/{1}/{2}.{3}", Application.dataPath + "/Resources/Lesson", dirname, fileName, "wav");
