...
public class PathEditor  : BaseEditorExtra<TrackPath>
{
    public static string kPreferTangentSelectionKey = "PathEditor.PreferTangentSelection";
    ...
    void DrawWaypointEditor(Rect rect, int index)
    {
        ...
        TrackPath.Waypoint def = new TrackPath.Waypoint();
        ...
        if (GUI.Button(r, buttonContent, style) && SceneView.lastActiveSceneView != null)
        {
            ...
            TrackPath.Waypoint wp = Target.m_Waypoints[index];
        ...
        if (GUI.Button(r, buttonContent, style))
        {
            ...
            var list = new List<TrackPath.Waypoint>(Target.m_Waypoints);
            list.RemoveAt(index);
    ...
    {
        TrackPath.Waypoint wp = Target.m_Waypoints[i];
    ...
    public static void DrawPathGizmo(TrackPath path, Color pathColor, bool isActive)
    {
        // Draw the path
    ...
    [DrawGizmo(GizmoType.Active | GizmoType.NotInSelectionHierarchy
         | GizmoType.InSelectionHierarchy | GizmoType.Pickable, typeof(TrackPath))]
    static void DrawGizmos(TrackPath path, GizmoType selectionType)
    {
