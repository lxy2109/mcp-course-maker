...
try:
    ...
    pass  # 如果未安装python-dotenv则跳过，不影响原有逻辑
...
def get_excel_path(filename: str) -> str:
    """Get full path to Excel file, supporting subdirectories under EXCEL_FILES_PATH.
    
    Args:
        filename: Name of Excel file, can include subdirectory (e.g. "subdir/file.xlsx")
