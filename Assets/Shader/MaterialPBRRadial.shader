...
Shader "MaterialPBR"
{
	Properties
	{
		...
		_AnisotropyStrength("Anisotropy Strength", Range( 0 , 1)) = 0.9297537
		_mainColor("mainColor", Color) = (0.9622642,0.9558519,0.9032574,0)
		_metallic("metallic", Range( 0 , 1)) = 1
		_smoothness("smoothness", Range( 0 , 1)) = 0.8705882
		[ASEEnd]_EmissionStyrength("Emission Styrength", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 tangentToWorldDir60 = mul( ase_tangentToWorldFast, UnpackNormalScale( tex2D( _TextureSample0, uv_TextureSample0 ), 1.0 ) );
				
				float2 texCoord39 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 normalizeResult41 = normalize( ( texCoord39 - float2( 0.5,0.5 ) ) );
				float2 break43 = normalizeResult41;
				float4 appendResult42 = (float4(break43.x , break43.y , 0.0 , 0.0));
				float2 uv_NormalMap = IN.ase_texcoord8.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 tangentToWorldDir55 = mul( ase_tangentToWorldFast, UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0 ) );
				float dotResult33 = dot( ( appendResult42 * -1.0 ) , float4( reflect( WorldViewDirection , tangentToWorldDir55 ) , 0.0 ) );
				float clampResult68 = clamp( ( abs( dotResult33 ) * 2.0 ) , 0.0 , 1.0 );
				
				float3 Albedo = _mainColor.rgb;
				float3 Normal = tangentToWorldDir60;
				float3 Emission = ( ( float3(1,1,1) * pow( ( 1.0 - clampResult68 ) , _AnisotropyStrength ) ) * _EmissionStyrength );
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 tangentToWorldDir55 = mul( ase_tangentToWorldFast, UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0 ) );
				float dotResult33 = dot( ( appendResult42 * -1.0 ) , float4( reflect( ase_worldViewDir , tangentToWorldDir55 ) , 0.0 ) );
				float clampResult68 = clamp( ( abs( dotResult33 ) * 2.0 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18935
889;415;1016;956;1797.289;532.7017;2.532892;False;False
Node;AmplifyShaderEditor.UnpackScaleNormalNode;61;86.24887,44.19317;Inherit;True;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ClampOpNode;68;-322.5304,354.9846;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;162.8666,326.7323;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;31;-1555.696,367.9515;Inherit;True;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;62;-261.1531,86.81806;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;47ba0289adf538c4ba3e0df681832139;47ba0289adf538c4ba3e0df681832139;True;0;True;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformDirectionNode;55;-1533.528,644.9022;Inherit;True;Tangent;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;59;1070.035,813.9202;Inherit;False;Property;_smoothness;smoothness;5;0;Create;True;0;0;0;False;0;False;0.8705882;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;67;-1286.267,365.7688;Inherit;False;Constant;_Float2;Float 2;9;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;47;-169.5042,463.3249;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;1048.035,670.9202;Inherit;False;Property;_metallic;metallic;4;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-626.1994,438.1538;Inherit;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;57;618.7043,104.8666;Inherit;False;Property;_mainColor;mainColor;3;0;Create;True;0;0;0;False;0;False;0.9622642,0.9558519,0.9032574,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode;33;-862.8894,325.8896;Inherit;True;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;274.8769,610.5105;Inherit;False;Property;_EmissionStyrength;Emission Styrength;6;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;35;-637.887,335.8168;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;23;-2082.57,580.0566;Inherit;True;Property;_NormalMap;Normal Map;0;0;Create;True;0;0;0;False;0;False;-1;47ba0289adf538c4ba3e0df681832139;47ba0289adf538c4ba3e0df681832139;True;0;True;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-479.298,553.808;Inherit;False;Property;_AnisotropyStrength;Anisotropy Strength;2;0;Create;True;0;0;0;False;0;False;0.9297537;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;50;-2136.906,335.1368;Inherit;False;Constant;_Vector1;Vector 1;4;0;Create;True;0;0;0;False;0;False;0.5,0.5;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleSubtractOpNode;49;-1907.907,129.1376;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.UnpackScaleNormalNode;53;-1789.924,609.9022;Inherit;True;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;42;-1268.888,210.6646;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.NormalizeNode;41;-1687.955,125.5392;Inherit;True;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;-1090.756,279.4417;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ReflectOpNode;32;-1261.712,533.4917;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BreakToComponentsNode;43;-1421.366,180.4336;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.TextureCoordinatesNode;39;-2163.858,47.68487;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;36;-16.79136,542.491;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;64;520.1509,339.9654;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TransformDirectionNode;60;355.3522,84.17989;Inherit;True;Tangent;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;73;-98.72536,339.801;Inherit;False;Constant;_Vector2;Vector 2;9;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-468.3121,311.3616;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;117,10;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=2EEF9D3E22CBD0B4D552E226E299517CA59E2103