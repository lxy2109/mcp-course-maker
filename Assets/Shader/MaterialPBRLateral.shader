	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float dotResult33 = dot( WorldTangent , reflect( WorldViewDirection , tangentToWorldDir55 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 tangentToWorldDir55 = mul( ase_tangentToWorldFast, UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0 ) );
				float dotResult33 = dot( ase_worldTangent , reflect( ase_worldViewDir , tangentToWorldDir55 ) );
				float clampResult68 = clamp( ( abs( dotResult33 ) * 2.0 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18935
1001;329;1204;485;1735.051;240.2969;1.886895;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;58;615.6962,576.9335;Inherit;False;Property;_metallic;metallic;4;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;33;-862.8894,325.8896;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexTangentNode;112;-1178.618,229.5164;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;59;643.9619,676.0734;Inherit;False;Property;_smoothness;smoothness;5;0;Create;True;0;0;0;False;0;False;0.8705882;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=96AA666E5392474988B327A51579B9D025A4D464